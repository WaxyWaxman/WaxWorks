...
- **Below-cost pricing proceeds and raises a review flag** for a manager rather than blocking (M-04 decision 8), which applies to shelf prices set here as well as at receiving.
