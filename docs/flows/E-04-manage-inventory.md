...
- **Can a correction here ever land inside a sealed period?** [M-08](M-08-general-ledger.md)'s
  ...
  **The likely answer is that it cannot**, because [M-07](M-07-chart-of-accounts.md) d8
  ...
  saying so; if it does not, this flow needs a refusal. **Raised by the [M-08](M-08-general-ledger.md) audit**, which found that neither flow mentions M-08 or a sealed period at all. **Deferred with M-08** ([M-08](M-08-general-ledger.md) d32, #78): there is no sealed period in the first build for a correction to land in, so the question waits for the second iteration with the flow that owns it.
