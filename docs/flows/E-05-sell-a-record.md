...
| **Pay-out** | Cash removed from the till for an expense. Requires a note describing the purpose. Appears as a negative cash line in the M-03 close. **Settles on its own** (decision 35) — it is the cash movement, not half of one, so it needs no offsetting tender and a Sale carrying only a pay-out is fully tendered. |
