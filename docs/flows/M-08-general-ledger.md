...
- **What does a statement do with lines dated after its as-at date?**
  [architecture](../architecture.md) A-73 permits a **future-dated** posting — a cheque
  written today against next month, a known future charge — which is a deliberate choice
  against the tighter bound, and it leaves this. A balance sheet as at 30 September drawn
  in August either includes a line dated 15 September or it does not, and **every statement
  must answer the same way** or two reports of one moment disagree. Related and unanswered:
  whether such a line appears in decision 24's *activity in the period*, and what a seal
  does with a posting dated beyond the period it is sealing.
