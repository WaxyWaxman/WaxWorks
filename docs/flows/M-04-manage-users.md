...
- **May a User's initials or display name be changed after creation?** Decision 19 gives new initials on reactivation and decision 13 sets them at creation, but an ordinary correction — a misspelled name, a marriage, a clash resolved the other way — has no recorded behaviour. It would want the same before-and-after log a role change gets.
