...
4. **Environments** — what database a Vercel preview deployment runs against (local Supabase in CI, one shared preview project, Supabase branching); where secrets live; the service-role key server-side only (A-91).
