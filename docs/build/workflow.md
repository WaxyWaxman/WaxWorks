...
|---|---|---|---|---|
| **Coordinator** | the main session | [`docs/build/plan.md`](plan.md) at the end of every session; [`docs/build/status.md`](status.md); the Scope, Checklist and Verdict sections of a work order; routes | code, tests, decisions | convention |
