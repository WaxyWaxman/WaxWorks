...
| [M-08](flows/M-08-general-ledger.md) | Specified — **deferred to the second iteration** (d32) | **Nothing built, and not coming in the first build** | 31 decisions and no screens. This is the ledger M-07 d27 reversed d1 to allow: an **opening position** typed from paper at migration (d6, d26, d28), **postings a Manager types** for rent, loans, depreciation and draws (Phase 2), **sealing** a month or a year (d4, d29, and a *filed* year that never reopens, d22), and **reading the books** — balances, a P&L, a balance sheet and reconciliation (d24, d25, d30, d31). The chart it posts to is built (M-07); the journals its artifacts write are built (M-07 Phase 3); **everything this flow adds on top is not.** Note d31 moves the journal export here, so M-07's Phase 4 screen is not coming |
