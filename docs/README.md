...
| [build/](build/) | How code gets built past the prototype: the [workflow](build/workflow.md), the [conventions](build/conventions.md) the developer codes to, the [build-status table](build/status.md), and the work orders |
