...
| E-06-T15 | **Routing waits for the finished Return.** On a Draft, **Route stock is not offered at all**. Tender the refund and finish; the Return takes its number and the copy is **still unrouted** — off the shelf, absent from the titlecard's present copies. Route it then. The draft path that minted a sellable copy with no refund paid and no tendered document does not exist. | 5, 6 | E-06 decision 20, E-06 decision 6 | As T1 | Walked | — | |
| E-06-T16 | **A finished Return with unrouted stock can be voided.** The half of decision 10 that decision 20 made reachable, and which could not happen while finishing required routing: finish a Return, leave the copy unrouted, then Void — **permitted**, on [E-05](../flows/E-05-sell-a-record.md) decision 31's terms with the refund off it first. Route the copy and Void is refused instead, which is **E-06-T5** — the two rows are the pair. | 5; prototype notes | E-06 decision 10, E-06 decision 20, E-05 decision 31 | As T1 | Walked | — | |
...
| E-06-T18 | **A voided Return cannot route its copy.** Finish a Return leaving the copy unrouted, void it on [E-05](../flows/E-05-sell-a-record.md) decision 31's terms (collecting the refund back), then try to route: **there is no Route control**, and the write path refuses if reached another way. The copy is not on the shelf and no copy is minted. Pairs with **E-06-T5**, which is the same exclusion in the other order. | 6; prototype notes | E-06 decision 22, E-06 decision 20, E-06 decision 10 | As T1 | Planned | — | |
| E-06-T19 | **Routing outlives the day close.** Finish a Return leaving the copy unrouted, run [M-03](../flows/M-03-daily-summary.md)'s close — which does **not** refuse on the unrouted copy — then route it the next morning from the `Closed` Return. The copy reaches the shelf normally. The rule is *finished and not voided*, never *only while `Current`*. | 6 | E-06 decision 23, E-06 decision 20, M-03 decision 4 | As T1; a day close between the Return and the routing | Walked | — | |
...
| M4 Till | E-05-T1–T3, T5–T16, E-06-T1–T21, E-07-T1–T7, E-04-T2, E-04-T4, E-04-T7, M-06-T1, T2, T4, T11 |
