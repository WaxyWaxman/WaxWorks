...
| M-08-T6 | ~~**Sealing reports every failure without sealing, and a Suspense line does not block it.**~~ — **Stale: decision 15 is superseded by decision 40**, which **refuses** the seal on a non-zero Suspense balance. Needs rewriting to assert the refusal, the **gross** total it reports, the **override** that clears it (decisions 14, 39), and that the **day close is unaffected** — M-07 d10 protects the close, decision 40 stops the seal, and decision 4 made those two words. *The original scenario follows.* Leave an unbalanced posting and an invalid code in the period: the seal reports both and seals nothing. Fix, re-run, seal | 16–20 | ~~M-08 decision 15~~ superseded by M-08 decision 40, M-08 decision 20, M-07 decision 10, M-07 decision 25, A-75, A-76 | A period with postings, and a journal forced to Suspense | Stale | Stale |  |
